...
// const generateAllDetail = function(path, length) {
//   return new Promise((resolve, reject) => {
//     const output = fs.createWriteStream(path, {encoding: 'utf8'});
...
//     (async() => {
//       for (var i = 0; i < length; i++) {
//         const obj = generateDetailJSON(i);
...
// for (var i = 0; i < 10; i++) {
//   generateAllDetail(`./db/neo4j/neo4Data/detailNeoCSV${i}.csv`, 1000000);
// }
